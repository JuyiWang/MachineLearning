...
![neurol network](Img/nerual&#32;network.png)
...
![theta 1](Img/theta1.png)

由隐藏层至输出层：

![theta 2](Img/theta2.png)
...
![Multi classification](Img/Multi&#32;classification.png)

### 七、神经网络:学习(Neural Networks:Learning)

#### 7.1 代价函数

![NN-C](Img/NN-classification.png)
...
![NN-costfunc](Img/NN-Costfunc.png)
...
![nn-pre](Img/nn-pro.png)

反向传播算法：

![nn-back](Img/nn-back.png)
...
![nn-back-alg](Img/nn-back-algorithm.png)
...
![nn-val-pre](Img/nn-val-pre.png)

反向传播算法：

![nn-val-alg](Img/nn-val-algorithm.png)

![nn-val-back](Img/nn-val-back.png)
...
![nn-gradient-check](Img/nn-g-check.png)
...
1. **选择适合的网络架构**
    ...
    ![network structure](Img/nn-network-struct.png)
...
![nn-train-test](Img/nn-train-test.png)
...
![nn-train-val-test](Img/nn-train-val-test.png)
...
![nn-bias-variance](Img/nn-bias-variance.png)
...
![nn-underfit-overfit](Img/nn-under-over-fit.png)
...
![nn-bias](Img/nn-high-bias.png)

**高方差**情况下：交叉验证误差一直很大，和训练误差之间差距一直很大，此时增加更多数据可能会有帮助

![nn-variance](Img/nn-high-variance.png)
...
![nn-model-choice](Img/nn-model-choice.png)
